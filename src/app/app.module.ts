...
import { RegisterUserApi, LoopBackAuth, SDKModels, InternalStorage } from './shared/sdk';
...
import { PostQueueStore } from './store/post-queue-store';
...
@NgModule({
  ...
  providers: [HttpClient, WrappedSocket, SocialAccountsStore,
    UserProfile, ManageCompanyStore, FormBuilder, CampaignService, PostQueueStore, CampaignsStore, CampaignStatusStore, RegisterUserApi, LoopBackAuth, SDKModels, InternalStorage],
