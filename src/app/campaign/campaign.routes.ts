...
export const routes: Routes = [
  {
    path: "",
    component: CreateCampaignContainerComponent,
    data: { name: "Create Campaign" }
  },
  {
    path: "campaign-list",
    component: CampainListContainerComponent,
    data: { name: "Campaign List" }
  },
  {
    path: "campaign-calendar",
    component: CampaignCalendarComponent,
    data: { name: "Campaign Calendar" }
  },
  {
    path: "edit-campaign",
    component: EditCampaignContainerComponent,
    data: { name: "Edit Campaign" }
  },
  {
    path: "box-popup",
    component: BoxPopupOpenerComponent,
    data: { name: "Popup Box" }
  }
];
@NgModule({
