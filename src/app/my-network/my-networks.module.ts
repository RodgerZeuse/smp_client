...
import { MatGridListModule, MatIconModule, MatListModule, MatProgressBarModule, MatFormFieldModule, MatSlideToggleModule } from '@angular/material';
...
import { AttachedAccountsDetailsComponent } from './attached-accounts-details/attached-accounts-details.component';
...
@NgModule({
  ...
  declarations: [AttachedAccountsDetailsContainerComponent,LinkedinConnectorComponent,SocialMediaDetailsSelecterComponent, AttachedAccountsDetailsComponent, SearchAccountComponent, MyNekworkStatusComponent, MyNetworksContainerComponent, MyNetworkComponent, AddNetworksComponent, FacebookConnectorComponent, YoutubeConnectorComponent, InstagramConnectorComponent, SocialMediaConnectorComponent, TwitterConnectorComponent, PinterestConnectorComponent],
